...
However, OCSPRequests that conform to this profile MAY include two
Requests in the OCSPRequest.RequestList structure,
if those requests are for SHA-1 and SHA-256 certID
